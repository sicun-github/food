				...
				<view class="right">
					<van-image
						...
						:src="
							avatar
								? avatar
								: 'https://wx.qlogo.cn/mmopen/vi_32/Hx7MFkCEmZVHziaTTiaHSiaCs4ApnH5CD0nYOhOg1nYUUMYtxMXkL6L4VL5icRfO5w4LGzW5ib0FZicwj2MficyYfZgCw/132'
						"
					/>
				</view>
			</view>
			...
			boardcast: [
				{
					...
					coverPic:
						'https://go.cdn.heytea.com/storage/products/2020/05/25/d7f9a7e9ea3747778d301b443147cd82.png',
				},
				{
					title: '来颗布蕾QQ麻薯球',
					subtitle: '灵感之茶，与音乐共生',
					coverPic:
						'https://go.cdn.heytea.com/storage/products/2020/05/25/0346c403e88243eaa76aa334097ad8ec.png',
				},
				{
					title: '喜茶星球会员升级啦',
					subtitle: '点击了解升级详情',
					coverPic:
						'https://go.cdn.heytea.com/storage/products/2020/05/08/0a11147144ff42629e6eca9eeec53215.png',
				},
			],
			userinfo: {},
			user_pay: '',
